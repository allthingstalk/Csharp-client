...
namespace att.iot.client
{
    ...
    public class Server: IServer, IDisposable
    {
        ...
        public void Init(SortedDictionary<string, string> appSettings)
        {
        ...
        #region mqtt
        private void InitMqtt(SortedDictionary<string, string> appSettings)
        {
        ...
        /// <returns></returns>
        private string GetSetting(SortedDictionary<string, string> appSettings, string key, string defaultVal)
        {
            string found = appSettings[key];
        ...
        /// </summary>
        /// <param name="appSettings">The application settings.</param>
        private void InitHttp(SortedDictionary<string, string> appSettings)
        {
